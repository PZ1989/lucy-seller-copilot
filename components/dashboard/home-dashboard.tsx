...
export default function Home() {
  ...
  const accounts = [{ name: "Etsy", icon: "shop", connected: etsyConnected }, { name: "Telegram", icon: "send", connected: false }];
